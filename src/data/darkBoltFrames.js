...
export const DARK_BOLT_CAST_FRAME_MS = 100;
...
export const DARK_BOLT_PROJECTILE_TEXTURE_KEYS = Object.freeze(
  Object.fromEntries(
    DARK_BOLT_PROJECTILE_FRAMES.map(({ name }) => [name, `dark-bolt-projectile-${name}`]),
  ),
);
