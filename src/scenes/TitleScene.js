...
export class TitleScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Temporary artwork socket. The finished 16:9 title art will replace this
    // without changing the scene or input flow.
    ...
    // Avoid double-binding if a scene is reconstructed by Phaser.
  ...
  handleInput() {
    ...
    // Three deliberate blackout beats give the title transition an old-OVA,
    // analogue-flicker character while keeping timing in one place.
    ...
    this.time.delayedCall(1720, () => this.scene.start('GameScene'));
  }
}
